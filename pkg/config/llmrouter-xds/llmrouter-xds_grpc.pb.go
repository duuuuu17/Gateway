...
const (
	AggregatedDiscoveryService_StreamAggregatedResources_FullMethodName = "/llmrouter.xds.v1alpha1.AggregatedDiscoveryService/StreamAggregatedResources"
)
...
var AggregatedDiscoveryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "llmrouter.xds.v1alpha1.AggregatedDiscoveryService",
