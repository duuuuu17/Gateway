...
import (
	...
	"github.com/duuuuu17/llm-router-operator/test/utils"
)
...
var _ = Describe("Manager", Ordered, func() {
	...
	Context("Manager", func() {
		...
		It("should have CA injection for LLMRouterConfig conversion webhook", func() {
			By("checking CA injection for LLMRouterConfig conversion webhook")
			verifyCAInjection := func(g Gomega) {
				cmd := exec.Command("kubectl", "get",
					"customresourcedefinitions.apiextensions.k8s.io",
					"llmrouterconfigs.config.llm-router.example.io",
